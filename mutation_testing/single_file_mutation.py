"""
This script performs mutation testing on the optax/schedules/_schedule.py file
"""
...
class MutationTester:
    ...
    def __init__(self, project_root: Path):
        self.project_root = project_root
        self.results_dir = project_root / "mutation_testing" / "results"
...
def main():
    ...
    target_file = "optax/schedules/_schedule.py"
    test_file = "optax/schedules/_schedule_test.py"
    ...
    # Save results
    results_dir = project_root / "mutation_testing" / "results"
