...
def trace(
  ...
  def init_fn(params: base.Params) -> TraceState:
    return TraceState(
...
def ema(
  ...
  def init_fn(params: base.Params) -> EmaState:
    return EmaState(
...
def scale_by_rss(
  ...
  def init_fn(params: base.Params) -> ScaleByRssState:
  ...
  def update_fn(
      updates, state: ScaleByRssState, params: Optional[base.Params] = None
  ) -> tuple[base.Updates, ScaleByRssState]:
    del params
    sum_of_squares = jax.tree_util.tree_map(
...
def scale_by_rms(
  ...
  def init_fn(params: base.Params) -> ScaleByRmsState:
  ...
  def update_fn(
      ...
      params: Optional[base.Params] = None,
  ) -> tuple[base.Updates, ScaleByRmsState]:
    del params
...
def scale_by_stddev(
  ...
  def init_fn(params: base.Params) -> ScaleByRStdDevState:
  ...
  def update_fn(
      ...
      params: Optional[base.Params] = None,
  ) -> tuple[base.Updates, ScaleByRStdDevState]:
    del params
    mu = update_moment(updates, state.mu, decay, 1)
    nu = update_moment_per_elem_norm(updates, state.nu, decay, 2)
    updates = jax.tree_util.tree_map(
        lambda g, m, n: g * jax.lax.rsqrt(n - _abs_sq(m) + eps), updates, mu, nu
    )
...
def scale_by_adam(
  ...
  def update_fn(
      ...
      params: Optional[base.Params] = None,
  ) -> tuple[base.Updates, ScaleByAdamState]:
    del params
...
def scale_by_amsgrad(
  ...
  def init_fn(params: base.Params) -> ScaleByAmsgradState:
    mu = jax.tree_util.tree_map(  # First moment
        lambda t: jnp.zeros_like(t, dtype=mu_dtype), params
    )
    nu = jax.tree_util.tree_map(jnp.zeros_like, params)  # Second moment
  ...
  def update_fn(
      updates: base.Updates,
      state: ScaleByAmsgradState,
      params: Optional[base.Params] = None,
  ) -> tuple[base.Updates, ScaleByAmsgradState]:
    del params
    mu = update_moment(updates, state.mu, b1, 1)
    nu = update_moment_per_elem_norm(updates, state.nu, b2, 2)
    count_inc = numerics.safe_int32_increment(state.count)
...
def scale_by_adamax(
  ...
  def init_fn(params: base.Params) -> ScaleByAdamState:
    mu = jax.tree_util.tree_map(jnp.zeros_like, params)  # First moment
...
def scale_by_lion(
  ...
  def init_fn(params: base.Params) -> ScaleByLionState:
  ...
  def update_fn(
      updates: base.Updates, state, params: Optional[base.Params] = None
  ) -> tuple[base.Updates, ScaleByLionState]:
    del params
...
def scale_by_param_block_norm(
  ...
  def update_fn(
      updates: base.Updates, state: base.EmptyState, params: base.Params
...
def scale_by_belief(
  ...
  def init_fn(params: base.Params) -> ScaleByBeliefState:
    mu = jax.tree_util.tree_map(jnp.zeros_like, params)  # First moment
  ...
  def update_fn(
      updates: base.Updates,
      state: ScaleByBeliefState,
      params: Optional[base.Params] = None,
  ) -> tuple[base.Updates, ScaleByBeliefState]:
    del params
    mu = update_moment(updates, state.mu, b1, 1)
...
def scale_by_radam(
  ...
  def update_fn(
    ...
    updates = jax.lax.cond(
        ro >= threshold, _radam_update, lambda _: mu_hat, (ro, mu_hat, nu_hat)
    )
    return updates, ScaleByAdamState(count=count_inc, mu=mu, nu=nu)
...
def scale_by_rprop(
  ...
  def init_fn(params: base.Params) -> ScaleByRpropState:
  ...
  def update_fn(
      updates: base.Updates,
      state: ScaleByRpropState,
      params: Optional[base.Params] = None,
  ) -> tuple[base.Updates, ScaleByRpropState]:
    del params
...
def add_decayed_weights(
  ...
  def update_fn(updates: base.Updates, state, params):
    if params is None:
      raise ValueError(base.NO_PARAMS_MSG)
    updates = jax.tree_util.tree_map(
...
def scale_by_schedule(
  ...
  def init_fn(params: base.Params) -> ScaleByScheduleState:
    del params
  ...
  def update_fn(
      ...
      params: Optional[base.Params] = None,
  ) -> tuple[base.Updates, ScaleByScheduleState]:
    del params
...
def scale_by_trust_ratio(
  ...
  def init_fn(params: base.Params) -> ScaleByTrustRatioState:
    del params
    return ScaleByTrustRatioState()

  def update_fn(
      updates: base.Updates, state: ScaleByTrustRatioState, params: base.Params
  ):
    if params is None:
      raise ValueError(base.NO_PARAMS_MSG)
...
def add_noise(
  ...
  def init_fn(params: base.Params) -> AddNoiseState:
    del params
  ...
  def update_fn(
      ...
      state: AddNoiseState,
      params: Optional[base.Params] = None,
  ) -> tuple[base.Updates, AddNoiseState]:
    del params
...
def apply_every(k: int = 1) -> base.GradientTransformation:
  ...
  def init_fn(params: base.Params) -> ApplyEvery:
...
def scale_by_sm3(
  ...
  def init_fn(params: base.Params) -> ScaleBySM3State:
  ...
  def update_fn(
      ...
      params: Optional[base.Params] = None,
  ) -> tuple[base.Updates, ScaleBySM3State]:
    del params
...
def scale_by_novograd(
  ...
  def init_fn(params: base.Params) -> ScaleByNovogradState:
    mu = jax.tree_util.tree_map(  # First moment
        lambda t: jnp.zeros_like(t, dtype=mu_dtype), params
    )
  ...
  # Second moment
  def update_fn(
      updates: base.Updates, state: ScaleByNovogradState, params: base.Params
  ) -> tuple[base.Updates, ScaleByNovogradState]:
    count_inc = numerics.safe_int32_increment(state.count)
...
def scale_by_distance_over_gradients(
  ...
  def init_fn(params: base.Params) -> ScaleByDistanceOverGradientsState:
  ...
  def update_fn(
      ...
      params: base.Params,
  ) -> tuple[base.Updates, ScaleByDistanceOverGradientsState]:
    # update max distance
