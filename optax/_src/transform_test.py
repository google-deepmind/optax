...
class TransformTest(parameterized.TestCase):
    ...
    @parameterized.named_parameters(
        [
            ...
            (
                "distance_over_gradients",
                transform.scale_by_distance_over_gradients,
            ),
    ...
    def test_apply_every(self):
        ...
        for i in range(STEPS):
            # Apply a step of sgd
            updates_sgd, state_sgd = sgd.update(
                self.per_step_updates, state_sgd
            )
            optax_sgd_params = update.apply_updates(
                optax_sgd_params, updates_sgd
            )
