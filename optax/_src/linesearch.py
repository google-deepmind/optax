...
def scale_by_backtracking_linesearch(
  ...
  def update_fn(
    ...
    def body_fn(
      ...
      return otu.tree_cast(new_search_state, other_tree=search_state)
    ...
    return new_updates, otu.tree_cast(new_state, other_tree=state)
...
def zoom_linesearch(
  ...
  def _try_safe_step(
    ...
    return otu.tree_cast(final_state, other_tree=state)
  ...
  def _search_interval(
    ...
    return otu.tree_cast(new_state, other_tree=state)
...
def scale_by_zoom_linesearch(
  ...
  def update_fn(
    ...
    return scaled_updates, otu.tree_cast(new_state, other_tree=state)
