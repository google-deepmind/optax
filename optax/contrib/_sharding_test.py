...
OPTIMIZERS = {
    'acprop': contrib.acprop(1e-3),
    'ademamix': contrib.ademamix(1e-3),
    'adopt': contrib.adopt(1e-2),
    'cocob': contrib.cocob(),
    'dadapt_adamw': contrib.dadapt_adamw(1e-1),
    'dog': contrib.dog(1.0),
    'dowg': contrib.dowg(1.0),
    'galore': contrib.galore(1e-2, rank=4),
    'madgrad': contrib.madgrad(1e-2),
    'muon': contrib.muon(1e-2),
    'prodigy': contrib.prodigy(1e-1),
    'schedule_free_adamw': contrib.schedule_free_adamw(
        1e-2, warmup_steps=5000
    ),
    'schedule_free_sgd': contrib.schedule_free_sgd(
        1e-2, warmup_steps=5000
    ),
    'simplified_ademamix': contrib.simplified_ademamix(1e-3),
}
